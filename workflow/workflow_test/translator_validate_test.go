// Package workflow_test also holds the exhaustive rejection-branch cases
...
func TestEmitMessageAckedValidateFailureModes(t *testing.T) {
	...
	for _, tt := range cases {
		t.Run(tt.name, func(t *testing.T) {
			...
			err := workflow.EmitMessageAcked(context.Background(), bus, tt.ack)
			if err == nil {
...
func TestEmitThreadVerifiedFailureModes(t *testing.T) {
	...
	for _, tt := range cases {
		t.Run(tt.name, func(t *testing.T) {
			...
			err := workflow.EmitThreadVerified(context.Background(), bus, tt.msgs)
			if err == nil {
