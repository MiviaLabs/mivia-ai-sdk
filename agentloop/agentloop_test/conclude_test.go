...
func TestRunConcludeMarginZeroUnchanged(t *testing.T) {
	...
	loop, err := agentloop.New(agentloop.Options{
		Completer: completer, Tools: reg, Bounds: agentloop.Bounds{MaxIterations: 3}, Extensions: &agentloop.Extensions{Conclude: agentloop.Conclude{Margin: 0}},
	})
	if err != nil {
...
func TestRunConcludeMarginNudgesNextToLastCall(t *testing.T) {
	...
	loop, err := agentloop.New(agentloop.Options{
		Completer: completer, Tools: reg, Bounds: agentloop.Bounds{MaxIterations: 5}, Extensions: &agentloop.Extensions{Conclude: agentloop.Conclude{Margin: 2}},
	})
	if err != nil {
		t.Fatalf("New() error = %v, want nil", err)
	}
...
func TestRunConcludeMarginNudgesLastCallOnly(t *testing.T) {
	...
	loop, err := agentloop.New(agentloop.Options{
		Completer: completer, Tools: reg, Bounds: agentloop.Bounds{MaxIterations: 5}, Extensions: &agentloop.Extensions{Conclude: agentloop.Conclude{Margin: 1}},
	})
	if err != nil {
		t.Fatalf("New() error = %v, want nil", err)
	}
...
func TestRunConcludeMarginFiresOnFirstIteration(t *testing.T) {
	...
	loop, err := agentloop.New(agentloop.Options{
		Completer: completer, Tools: reg, Bounds: agentloop.Bounds{MaxIterations: 1}, Extensions: &agentloop.Extensions{Conclude: agentloop.Conclude{Margin: 1}},
	})
	if err != nil {
		t.Fatalf("New() error = %v, want nil", err)
	}
...
func TestRunConcludeMarginModelIgnoresNudge(t *testing.T) {
	...
	loop, err := agentloop.New(agentloop.Options{
		Completer: completer, Tools: reg, Bounds: agentloop.Bounds{MaxIterations: 3}, Extensions: &agentloop.Extensions{Conclude: agentloop.Conclude{Margin: 2}},
	})
	if err != nil {
		t.Fatalf("New() error = %v, want nil", err)
	}
...
func TestRunConcludeNoticeDefaultAndOverride(t *testing.T) {
	...
	for _, c := range cases {
		t.Run(c.name, func(t *testing.T) {
			...
			loop, err := agentloop.New(agentloop.Options{
				Completer: completer, Tools: reg, Bounds: agentloop.Bounds{MaxIterations: 1}, Extensions: &agentloop.Extensions{Conclude: agentloop.Conclude{Margin: 1, Notice: c.notice}},
			})
			if err != nil {
				t.Fatalf("New() error = %v, want nil", err)
			}
...
func TestRunConcludeMarginTrimDropsNotice(t *testing.T) {
	...
	loop, err := agentloop.New(agentloop.Options{
		Completer: completer, Tools: reg, Bounds: agentloop.Bounds{MaxIterations: 3}, Extensions: &agentloop.Extensions{Conclude: agentloop.Conclude{Margin: 3}}, Trim: dropRoleUser,
	})
	if err != nil {
		t.Fatalf("New() error = %v, want nil", err)
	}
...
func TestRunConcludeMarginTrimDropsNoticeBeforeStop(t *testing.T) {
	...
	loop, err := agentloop.New(agentloop.Options{
		Completer: completer, Tools: reg, Bounds: agentloop.Bounds{MaxIterations: 3}, Extensions: &agentloop.Extensions{Conclude: agentloop.Conclude{Margin: 2}}, Trim: dropRoleUser,
	})
	if err != nil {
		t.Fatalf("New() error = %v, want nil", err)
	}
...
func TestRunConcludeMarginZeroIgnoresCallerNoticeInHistory(t *testing.T) {
	...
	loop, err := agentloop.New(agentloop.Options{
		Completer: completer, Tools: reg, Bounds: agentloop.Bounds{MaxIterations: 1}, Extensions: &agentloop.Extensions{Conclude: agentloop.Conclude{Margin: 0}},
	})
	if err != nil {
		t.Fatalf("New() error = %v, want nil", err)
	}
