...
a retry loop; see docs/plans/agents/phase30_flow_retry.md. Phase 38
shipped a loop-driving repeat of a step's `Sub`; see
docs/plans/agents/phase38_flow_loop.md and the Phase 38 subsection
below.
...
see docs/plans/agents/phase38_flow_loop.md and the Phase 38 subsection
below for the full contract, including why a graph cycle is rejected.
...
See docs/plans/agents/phase38_flow_loop.md for the full contract,
including the reasoning against a graph cycle. This subsection states
...
Full case list in docs/plans/agents/phase38_flow_loop.md. Test files
land in `flow/flow_test/`:
