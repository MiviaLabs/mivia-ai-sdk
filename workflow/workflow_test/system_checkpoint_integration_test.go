// Package workflow_test also holds the checkpoint pause and resume
// integration test. workflow.Run passes a nil onCheckpoint to flow.Run,
...
// mirrors workflow.confirmStep: build an envelope, chain it to the
