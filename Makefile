...
verify: verify-fast verify-ledger-sqlite
	...
	# The six packages formerly quarantined under x/ (contextstate,
	# contextsession, envfile, longtermmemory, runconfig, skills) are
	# folded back into the root module (Phase 87) and covered by
	# src_pkgs like every other package; no separate test invocation
	# is needed here.
