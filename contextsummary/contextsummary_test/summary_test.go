	...
	runValidateCases(t, []struct {
	...
	}{
		{
			...
			sum: contextsummary.Summary{
				Objective: "o",
				State:     "s",
				Evidence:  repeatItems(contextsummary.MaxItems + 1),
			},
			wantErr: true,
		},
		{
	...
	runValidateCases(t, []struct {
	...
	}{
		{
			...
			sum: contextsummary.Summary{
				Objective:       "o",
				State:           "s",
				ChangedSurfaces: repeatItems(contextsummary.MaxItems + 1),
			},
			wantErr: true,
		},
		{
...
func TestSummaryJSONRoundTrip(t *testing.T) {
	...
	var back contextsummary.Summary
	...
	bare := contextsummary.Summary{Objective: "o", State: "s"}
